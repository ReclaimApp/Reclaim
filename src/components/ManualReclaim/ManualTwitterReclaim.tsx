...
const ManualTwitterReclaim = (props) => {
  return (
    <div className={StyleSheet.landing}>
      <h2 className={StyleSheet.header}>Manually reclaim Twitter data</h2>
      ...
      <Col className={StyleSheet.twitterColumn}>
        ...
        <Button
          onClick={() => window.open('http://twitter.com/login')}
          as={StyledButton}
        >
          Login
        </Button>
        ...
        <ListGroup className={StyleSheet.listGroup}>
          <ListGroup.Item className={StyleSheet.subtext}>
            {' '}
            - Twitter will need to create your archive before you can download
            it
          </ListGroup.Item>
          <ListGroup.Item className={StyleSheet.subtext}>
            {' '}
          ...
          <ListGroup.Item className={StyleSheet.subtext}>
            {' '}
            - Urgent: If there is no folder called 'your_data' in your Documents
            you must create that folder and place your data inside of it for the
            app to function
          </ListGroup.Item>
        </ListGroup>
        <ListGroup.Item className={StyleSheet.subtext}>
